...
The Android build is available on the emulator. No video has been recorded yet.

- [ ] 0:00 — English, feature enabled, original 3 profiles. Show sheet movement and fixed service hours/buttons.
- [ ] 0:30 — Scroll to hotline, email and privacy notice. Use the top-left back icon to return to setup and confirm the selections are preserved.
